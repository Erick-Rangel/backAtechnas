...
// const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/atechnas`, {
...
const { User, Message, Review, Team, Testimonial, Language, Post, UserAdmin, Technology, Category, Payments, Publication } = sequelize.models;
